    ...
    <div className="relative flex items-center justify-between h-16">
      ...
      <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div className="flex-shrink-0 flex items-center">
          <img className="block lg:hidden h-8 w-auto" src="icons/parsar-logo.png" alt="Workflow"/>
          <img className="hidden lg:block h-8 w-auto" src="icons/parsar-logo.png" alt="Workflow"/>
        </div>
        <div className="logoName">
            <Link  href="/">
            <a className="text-yellow-500 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-lg font-bold"></a>
            </Link>
            </div>
